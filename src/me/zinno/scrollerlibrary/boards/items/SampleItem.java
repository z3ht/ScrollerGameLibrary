package me.zinno.scrollerlibrary.boards.items;
...
public class SampleItem implements BoardItem, Updatable {
	
	private App app;
	private Point location; // center of piece
	private Dimension size;
	
	public SampleItem(App app) {
		this(
				app,
				new Point(
	...
	public SampleItem(App app, Point location, Dimension size) {
		this.app = app;
